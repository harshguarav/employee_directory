...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-10 cursor-pointer rounded-full bg-black dark:bg-white p-2 transition-all duration-300 active:scale-95 hover:scale-105 flex items-center justify-center",
        className,
      )}
      onClick={toggleTheme}
...
export const createAnimation = (
  ...
  if (variant === "gif") {
    return {
      ...
      css: `
      ::view-transition-group(root) {
  animation-timing-function: var(--ease-expo-in);
}
